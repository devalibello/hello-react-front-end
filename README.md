...
**[Hello-React-Front-End]** is a project that uses a React/Redux to display greeting messages to users via Rails API.
...
[Hello-Rails-Back-End](https://github.com/devalibello/hello-rails-back-end)
